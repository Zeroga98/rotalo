...
@Component({
  selector: 'detail-product-shop-private',
  templateUrl: './detail-product-shop-private.component.html',
  styleUrls: ['./detail-product-shop-private.component.scss']
})
export class DetailProductShopPrivateComponent implements OnInit {
