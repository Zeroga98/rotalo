...
@Component({
  selector: 'product-microsite-private',
  templateUrl: './product-microsite-private.component.html',
  styleUrls: ['./product-microsite-private.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush
})

export class ProductMicrositePrivateComponent implements AfterViewInit, AfterContentInit {
  @Input() product;
  @Input() masonryInfo;
  ...
  selectProduct(event) {
    if (event.ctrlKey) {
      const routeDetailProduct = `${location.origin}/${ROUTES.SHOPSPRIVATE.LINK}/${ROUTES.SHOPSPRIVATE.SHOW}/${this.product['product_id']}`;
      window.open(routeDetailProduct, '_blank');
    } else {
      const routeDetailProduct = `${ROUTES.SHOPSPRIVATE.LINK}/${ROUTES.SHOPSPRIVATE.SHOW}/${this.product['product_id']}`;
  ...
  getUrlProduct(product: ProductInterface) {
    const routeDetailProduct = `../../${ROUTES.SHOPSPRIVATE.LINK}/${
