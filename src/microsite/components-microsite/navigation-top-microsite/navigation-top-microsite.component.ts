...
@Component({
  selector: "navigation-top-microsite",
  templateUrl: "./navigation-top-microsite.component.html",
  styleUrls: ["./navigation-top-microsite.component.scss"],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class NavigationTopMicrositeComponent implements OnInit, OnDestroy {
  ...
  validateRouter() {
    if (this.router.url.includes("microsite")) {
      this.isInMicrosite = true;
    }
  }

  clickUploadProduct() {
    if (!this.isInMicrosite) {
