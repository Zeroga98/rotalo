...
@Component({
  selector: 'app-preview-product-microsite',
  templateUrl: './preview-product-microsite.component.html',
  styleUrls: ['./preview-product-microsite.component.scss']
})

export class PreviewProductMicrositeComponent implements OnInit {
