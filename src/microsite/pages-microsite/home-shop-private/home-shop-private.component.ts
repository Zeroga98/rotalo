...
import { FeedShopPrivateMicrositeService } from './feedMicrosite.service';
...
@Component({
  selector: 'app-home-shop-private',
  templateUrl: './home-shop-private.component.html',
  styleUrls: ['./home-shop-private.component.scss']
})
export class HomeShopPrivateComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  constructor(private loginService: LoginService,
    ...
    private feedService: FeedShopPrivateMicrositeService,
